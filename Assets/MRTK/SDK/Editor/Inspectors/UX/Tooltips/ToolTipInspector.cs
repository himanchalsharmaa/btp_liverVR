    ...
    public class ToolTipInspector : UnityEditor.Editor
    {
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            if (DrawHandles)
            {
                ...
                var fmh_252_90_638075965503490000 = Quaternion.identity; Vector3 newPivotPosition = Handles.FreeMoveHandle(toolTip.PivotPosition, handleSize, Vector3.zero, Handles.SphereHandleCap);
                ...
                arrowSize = handleSize * 2;
                var fmh_263_92_638075965503493400 = Quaternion.identity; Vector3 newAnchorPosition = Handles.FreeMoveHandle(toolTip.AnchorPosition, HandleUtility.GetHandleSize(toolTip.AnchorPosition) * handleSizeMultiplier, Vector3.zero, Handles.SphereHandleCap);
                ...
                if (EditAttachPoint)
                {
                    ...
                    arrowSize = handleSize * 2;
                    var fmh_293_106_638075965503497050 = Quaternion.identity; Vector3 newAttachPointPosition = Handles.FreeMoveHandle(toolTip.AttachPointPosition, HandleUtility.GetHandleSize(toolTip.AttachPointPosition) * handleSizeMultiplier, Vector3.zero, Handles.SphereHandleCap);
